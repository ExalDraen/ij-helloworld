package org.alnx.example.ij.vfs;
...
public class HttpVirtualFileSystem extends VirtualFileSystem implements NonPhysicalFileSystem {

    private static final String HTTP_FS_PROTOCOL = "httpfs";

    @Override
    public @NonNls @NotNull String getProtocol() {
        return HTTP_FS_PROTOCOL;
    }
